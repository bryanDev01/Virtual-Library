...
export default function Home() {
  return (
    <section className="min-h-screen p-4 md:p-6 font-normal w-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col justify-center items-center py-12 md:py-16 space-y-6">
          ...
          <div className="space-y-4 text-center">
            <p className="text-4xl md:text-6xl font-bold text-balance tracking-tight text-white max-w-4xl animate-fade-in-up">
              Discover Your Next Adventure
            </p>
            <p className="text-lg text-slate-400 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
        ...
        <BookProvider>
          <FilterProvider>
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 mb-8 shadow-lg animate-fade-in-up animation-delay-400">
              <Filters />
              <Book />
            </div>
          </FilterProvider>
